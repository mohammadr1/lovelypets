        ...
        <div class="row">
            <div class="col-md-12">
                <form action="{{route('search')}}" method="get">
                    <input class="col-md-11 float-right" placeholder="دنبال چی میگردی..." type="text" name="keyword" value="<?php echo $_GET['keyword']; ?>" />
                    <button class="col-md-1" type="submit"><i class="fa fa-search" aria-hidden="true"></i></button>
                </form>
                
            <hr>
               
            @foreach($lessons as $article)
            <div class="cardItem col-md-4 col-sm-6 col-xs-12 mt-4 mb-4 float-right"
