                            ...
                            <div class="col-md-12 text-right">
                                <div class="formRegister">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="phone" name="phone"
                                                            ...
                                                            id="exampleInputEmail1" aria-describedby="phone"
                                                            placeholder="تلفن همراه" value="{{old('phone')}}">
                                                    </div>
                                                    @error('name')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="password" name="password"
                                                            ...
                                                            id="exampleInputPassword1" aria-describedby="password"
                                    ...
                                    <label class="form-check-label" for="exampleCheck1">Check me out</label>
                                                    ...
                                                    <button type="submit col-md-3 float-right"
                                                        class="btn btn-primary col-md-2">ثبت نام</button>
                                                </div>
                                            </div>
                                        </fieldset>

                                    </form>
                                    <button id="goLeft" class="off">ورود</button>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-12 text-right">
                                <div class="formLogin">
                                    <form action="{{route('login')}}" method="POST">
                                        ...
                                        <fieldset>
                                            <legend>فرم لاگین</legend>
                                            <br>

                                            <div class="form-group">
                                                <label for="title">ایمیل یا (نام کاربری)</label>
                                                <input type="email"
                                                    class="form-control @error('email') is-invalid @enderror"
                                    ...
                                    <a href="{{route('register')}}" class="btn btn-warning col-md-5 mt-2">
