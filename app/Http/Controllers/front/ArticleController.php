...
class ArticleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('front.articles', compact('articles', 'menus', 'sliders'));
    }
    ...
    public function show(Article $article)
    {
        ...
        $similar_article = DB::table('articles')
        ...
        // $Related_
        return view('front.article', compact('article', 'comments', 'similar_article', 'menus', 'sliders'));
    }
}
